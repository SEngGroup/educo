    ...
    <div class="signup-container">
        <div class="container">
            ...
            <form class="signup-form" action="server_auth.php" method="POST">
                ...
                <input id="button" name="sub" type="submit" value="SIGNUP">
                <p style="text-align: center; color: gray;">Already have an account?</p>
                <p style="text-align: center;"><a href="login.php" style="text-decoration: none; color: gray; font-size: 12px;">LOGIN</a></p>
            </form>
        </div>
    </div>
</body>
