...
if(isset($_SESSION['user_id'])) {} else{
  ...
  echo '<a id="link" target="_parent" href="login.php"></a>

<script type="text/javascript">
    document.getElementById("link").click();
</script>';}
include($_SERVER['DOCUMENT_ROOT'].'/Forum/User/Post_Com/config.php');
include($_SERVER['DOCUMENT_ROOT'].'/Forum/User/header.php');
    ...
    <div class="container">
        <div class="side-nav-bar">
            <ul class="chat-side-nav">
                ...
                <li class="side-links"><a href="flagged.php"><i class="fa fa-user side-nav" aria-hidden="true"></i>Flagged</a></li>
